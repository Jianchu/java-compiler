...
public class CodeGenTestMain {
    ...
    public static void main(String[] args) throws IOException,InterruptedException {
        ...
        //paths = FileUtility.getFileNames(myDir + "/test/testprogram/code_gen/TestString.java").toArray(paths);
        paths = FileUtility.getFileNames(myDir + "/assignment_testcases/a5/J1_NamedTypeArray.java").toArray(paths);
