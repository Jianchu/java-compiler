...
public class ParseTree extends Token{
    ...
    /**
     * Helper method for finding a child of specific type. Uses linear search.
     * Please only use when you know for certain from certain a node would
     * exist, and only appear once. e.g. finding Name in
